...
function sliderCtaHover() {
	...
	ctas.forEach((cta) => {
		...
		cta.addEventListener("mouseenter", () => {
			...
			// image in
			gsap.to(image, { opacity: 1, rotationY: 0, transformOrigin: "50% 50% -2000", duration: 0.55, ease: "myEaseSmooth", delay: 0.1 });
		});
		...
		cta.addEventListener("mouseleave", () => {
			...
			// image out
			gsap.to(image, { opacity: 0, rotationY: 55, transformOrigin: "50% 50% -2000", duration: 0.55, ease: "myEaseSmooth", delay: 0 });
